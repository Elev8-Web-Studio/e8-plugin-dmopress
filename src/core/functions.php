...
function dmopress_available_modules(){
	$available_modules = array(
		array(
			...
			'default' => 'enabled',
			'description' => 'Track and display accepted payments types at each of your Places.',
		),
		array(
			'slug' => 'tribe-events-calendar',
			'label' => __('Events Calendar and Events Calendar Pro','dmopress_textdomain'),
			'default' => 'enabled',
			'description' => 'Enables integration with the popular Events Calendar and Events Calendar Pro plugins.',
		),
		array(
			'slug' => 'map',
			'label' => __('Google Maps','dmopress_textdomain'),
			'default' => 'enabled',
			'description' => 'Display your Places on stylized, interactive Google Maps.',
		),
		array(
			'slug' => 'hours-of-operation',
			'label' => __('Hours of Operation','dmopress_textdomain'),
			'default' => 'enabled',
			'description' => 'Track and display the hours of operation for your Places.',
		),
		array(
			'slug' => 'tripadvisor',
			'label' => __('TripAdvisor','dmopress_textdomain'),
			'default' => 'enabled',
			'description' => 'Enables TripAdvisor shortcodes and widgets.',
		),
		array(
			'slug' => 'visual-composer',
			'label' => __('Visual Composer','dmopress_textdomain'),
			'default' => 'enabled',
			'description' => 'Enables integration with Visual Composer page builder plugin.',
		)
	);
