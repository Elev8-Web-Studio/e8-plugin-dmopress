<?php 
/**
 * Restaurants Detail Template
 *
 * This template displays a single Restaurants post.
 * By default, it shows all available Restaurants fields and,
 * if a Google Maps API Key is detected, it also displays a Google Map. 
 *
 * Documentation: 
 * {@link http://docs.tourismpress.net/designers/templatereference.html#single-restaurants-php}
 *
 * @package WordPress
			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6">
						...
						$features = get_the_terms($post_id, 'restaurant-features');
						if (!empty($features)) {
						...
						$categories = get_the_terms($post_id, 'restaurant-categories');
						if (!empty($categories)) {
