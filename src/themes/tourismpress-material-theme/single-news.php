 ...
 *
 * This template displays a single News post.
 * By default, it shows all available News fields.
 *
 * Documentation: 
 * {@link http://docs.tourismpress.net/designers/templatereference.html#single-news-php}
 *
 * @package WordPress
		...
		<div class="col-xs-12 col-sm-8">
			...
			<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				...
				<p>Categories:
					...
					$categories = get_the_terms($post_id, 'news-categories');
					if(!empty($categories))	{
