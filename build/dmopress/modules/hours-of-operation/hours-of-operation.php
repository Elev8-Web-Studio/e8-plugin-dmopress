...
require_once DMOPRESS_PLUGIN_DIR . '/modules/hours-of-operation/api.php';
...
function dmopress_place_meta_box_hours_of_operation_callback($post) {
	...
	$sunday_open = ($hours_of_operation && $hours_of_operation['sunday_open'] ? $hours_of_operation['sunday_open'] : 'none');
	$monday_open = ($hours_of_operation && $hours_of_operation['monday_open'] ? $hours_of_operation['monday_open'] : 'none');
	$tuesday_open = ($hours_of_operation && $hours_of_operation['tuesday_open'] ? $hours_of_operation['tuesday_open'] : 'none');
	$wednesday_open = ($hours_of_operation && $hours_of_operation['wednesday_open'] ? $hours_of_operation['wednesday_open'] : 'none');
	$thursday_open = ($hours_of_operation && $hours_of_operation['thursday_open'] ? $hours_of_operation['thursday_open'] : 'none');
	$friday_open = ($hours_of_operation && $hours_of_operation['friday_open'] ? $hours_of_operation['friday_open'] : 'none');
	$saturday_open = ($hours_of_operation && $hours_of_operation['saturday_open'] ? $hours_of_operation['saturday_open'] : 'none');

	$sunday_closed = ($hours_of_operation && $hours_of_operation['sunday_closed'] ? $hours_of_operation['sunday_closed'] : 'none');
	$monday_closed = ($hours_of_operation && $hours_of_operation['monday_closed'] ? $hours_of_operation['monday_closed'] : 'none');
	$tuesday_closed = ($hours_of_operation && $hours_of_operation['tuesday_closed'] ? $hours_of_operation['tuesday_closed'] : 'none');
	$wednesday_closed = ($hours_of_operation && $hours_of_operation['wednesday_closed'] ? $hours_of_operation['wednesday_closed'] : 'none');
	$thursday_closed = ($hours_of_operation && $hours_of_operation['thursday_closed'] ? $hours_of_operation['thursday_closed'] : 'none');
	$friday_closed = ($hours_of_operation && $hours_of_operation['friday_closed'] ? $hours_of_operation['friday_closed'] : 'none');
	$saturday_closed = ($hours_of_operation && $hours_of_operation['saturday_closed'] ? $hours_of_operation['saturday_closed'] : 'none');
	...
	<div class="container-flex">
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('sunday_open', $sunday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('sunday_closed', $sunday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('monday_open', $monday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('monday_closed', $monday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('tuesday_open', $tuesday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('tuesday_closed', $tuesday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('wednesday_open', $wednesday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('wednesday_closed', $wednesday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('thursday_open', $thursday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('thursday_closed', $thursday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('friday_open', $friday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('friday_closed', $friday_closed);
			echo '</p>';
			?>
		</div>
		<div class="column">
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('saturday_open', $saturday_open);
			echo '</p>';
			?>
			<?php
			...
			echo ': ';
			echo '</label><br />';
			echo dmopress_render_time_select('saturday_closed', $saturday_closed);
			echo '</p>';
			?>
		</div>
    </div>
